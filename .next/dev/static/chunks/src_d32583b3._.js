...
"[project]/src/lib/action/data:ef8137 [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$action$2f$data$3a$ef8137__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/lib/action/data:ef8137 [app-client] (ecmascript) <text/javascript>");
;
...
function LoginForm() {
    ...
    const onSubmit = async (data)=>{
        setError("");
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$action$2f$data$3a$ef8137__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["handleLogin"])(data);
            if (!res.success) {
...
//# sourceMappingURL=src_d32583b3._.js.map